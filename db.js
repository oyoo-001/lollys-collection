...
async function initializeTables() {
    try {
        ...
        await pool.execute(productTableSql);
        await pool.execute(userTableSql); 
        await pool.execute(cartTableSql); 
        await pool.execute(orderTableSql);
        await pool.execute(orderItemsTableSql);
